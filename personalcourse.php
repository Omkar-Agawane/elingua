<?php require 'header.php' ; 
    require './fetch/coursepersonalfetch.php';
...
<div class=" index product">
    ...
    <div class="container product-header">
        <h4>Personal Live Classes</h4> <br>
        <hr>
    </div>
    <div class="container">
        ...
        <?php if($page != 0){ ?>
            <span><a href="./personalcourse.php?nextpage=<?php echo $page-1;?>">&#8592;Previous Page </a></span>
            &nbsp;&nbsp;&nbsp;&nbsp;
        <?php } 
         if($pagination_var < $len){ ?>
            <span> <a href="./personalcourse.php?nextpage=<?php echo $page+1;?>">Next Page&#8594; </a></span>
         <?php } ?>
        </div>
    </div>
